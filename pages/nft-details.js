...
const NFTDetails = () => {
  ...
  const [nft, setNft] = useState({ image: '', token: '', name: '', price: '', seller: '' });
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="sm:px-4 p-12 border-r md:border-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
        ...
        <Modal
          ...
          body={(
            <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
              ...
              <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm minlg:text-xl mt-10">You successfully purchased <span className="font-semibold">{nft.name} </span> from <span className="font-semibold">{shortenAddress(nft.seller)} </span></p>
            </div>
          )}
          footer={(
